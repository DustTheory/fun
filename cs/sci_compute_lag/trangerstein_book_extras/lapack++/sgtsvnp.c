/* sgtsvnp.f -- translated by f2c (version 20090411).
...
/*     modified from sgtsv to avoid row pivoting */
/* Subroutine */ int sgtsvnp_(integer *n, integer *nrhs, real *dl, real *d__, 
