/* cgttrfnp.f -- translated by f2c (version 20090411).
...
/* modified from cgttrf to avoid pivoting */
/* Subroutine */ int cgttrfnp_(integer *n, complex *dl, complex *d__, complex 
	*du, integer *info)
{
	...
	*info = -1;
	i__1 = -(*info);
	xerbla_("cgttrfnp", &i__1, (ftnlen)8);
	return 0;
    }
    if (*n == 0) {
	return 0;
