/* sgtrfsr.f -- translated by f2c (version 20090411).
...
/*     modified from sgtrfs to multiply by matrix on the right */
/* Subroutine */ int sgtrfsr_(char *trans, integer *n, integer *nrhs, real *
	dl, real *d__, real *du, real *dlf, real *df, real *duf, real *du2, 
