/* zgtrfsr.f -- translated by f2c (version 20090411).
...
/* modified from zgtrfs to work with rows of b and x */
/* Subroutine */ int zgtrfsr_(char *trans, integer *n, integer *nrhs, 
...
/* Computing MAX */
	...
	if (berr[j] > eps && berr[j] * 2. <= lstres && count <= 5) {
	    ...
	    zgttrs_(ltrans, n, &c__1, &dlf[1], &df[1], &duf[1], &du2[1], &
