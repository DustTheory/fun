/* cgtsvnp.f -- translated by f2c (version 20090411).
...
/* modified from cgtsv to avoid pivoting */
/* Subroutine */ int cgtsvnp_(integer *n, integer *nrhs, complex *dl, complex 
	*d__, complex *du, complex *b, integer *ldb, integer *info)
{
	...
	*info = -7;
	...
	i__3 = k + 1;
	i__4 = k;
	q__2.r = mult.r * du[i__4].r - mult.i * du[i__4].i, q__2.i = mult.r * 
	...
	for (j = 1; j <= i__2; ++j) {
	    ...
	    i__4 = k + 1 + j * b_dim1;
	    i__5 = k + j * b_dim1;
	    q__2.r = mult.r * b[i__5].r - mult.i * b[i__5].i, q__2.i = mult.r 
