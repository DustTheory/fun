/* dgtsvnp.f -- translated by f2c (version 20090411).
...
/*     modified from dgtsv to avoid row pivoting */
/* Subroutine */ int dgtsvnp_(integer *n, integer *nrhs, doublereal *dl, 
