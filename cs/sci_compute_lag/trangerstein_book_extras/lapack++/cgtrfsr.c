/* cgtrfsr.f -- translated by f2c (version 20090411).
...
/* modified from cgtrfs to work with rows of b and x */
/* Subroutine */ int cgtrfsr_(char *trans, integer *n, integer *nrhs, complex 
...
/* Computing MAX */
	...
	if (berr[j] > eps && berr[j] * 2.f <= lstres && count <= 5) {
	    ...
	    cgttrs_(ltrans, n, &c__1, &dlf[1], &df[1], &duf[1], &du2[1], &
