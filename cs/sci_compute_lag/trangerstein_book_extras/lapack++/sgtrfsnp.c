/* sgtrfsnp.f -- translated by f2c (version 20090411).
...
/*     modified from sgtrfs to avoid pivoting */
/* Subroutine */ int sgtrfsnp_(char *trans, integer *n, integer *nrhs, real *
	...
	work, integer *iwork, integer *info, ftnlen trans_len)
{
	...
	*info = -13;
    ...
    if (*info != 0) {
	i__1 = -(*info);
	xerbla_("sgtrfsnp", &i__1, (ftnlen)8);
	return 0;
    }
    if (*n == 0 || *nrhs == 0) {
	i__1 = *nrhs;
...
L20:
	...
	slagtm_(trans, n, &c__1, &c_b16, &dl[1], &d__[1], &du[1], &x[j * 
