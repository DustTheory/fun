/* zgtsvrnp.f -- translated by f2c (version 20090411).
...
/* modified from zgtsvr to avoid pivoting */
/* Subroutine */ int zgtsvrnp_(integer *n, integer *nrhs, doublecomplex *dl, 
	 ...
	 integer *info)
{
	...
	*info = -7;
    ...
    if (*info != 0) {
	i__1 = -(*info);
	xerbla_("zgtsvrnp", &i__1, (ftnlen)8);
	return 0;
    }
    if (*n == 0) {
	return 0;
