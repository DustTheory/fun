c modifed from zgtts2 to avoid pivoting
      subroutine zgtts2np(itrans,n,nrhs,dl,d,du,b,ldb)
  ...
  130     continue
            ...
            if (n.gt.1) 
     &        b(2,j)=(b(2,j)-dconjg(du(1))*b(1,j))/dconjg(d(2))
            do i=3,n
              b(i,j)=(b(i,j)-dconjg(du(i-1))*b(i-1,j))/dconjg(d(i))
            enddo
            do i=n-1,1,-1
