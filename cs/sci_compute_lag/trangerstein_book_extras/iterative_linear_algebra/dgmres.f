...
c     IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      integer jscal,locdin,locigw,lociw,locrgw,locw,lxl,lz,lzm1,myitol
C
...
c     IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      EXTERNAL DSMV, DSDI
      integer locrb,locib,locigw,lociw,locdin,locrgw,locw,myitol
...
c     IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      DOUBLE PRECISION B(N), X(N), A(NELT), TOL, ERR, RWORK(LENW)
      EXTERNAL DSMV, DSLUI
      integer icol,j,jbgn,jend,locigw,locil,locjl,lociu,locju,locrb,
     &  locnr,locnc,lociw,locl,locdin,locu,locrgw,locw,locib,myitol,
     &  nl,nu
      PARAMETER (LOCRB=1, LOCIB=11)
C
C         Change the SLAP input matrix IA, JA, A to SLAP-Column format.
...
c     IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      integer isdgmr,iter,itmax,iunit
...
c     IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      integer llm1,llp1
      double precision c,prod,r0nrm,s,tem
C
C         Internal Variables.
C
      INTEGER I, IP1, I2, K
...
c     IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      integer i,ielmax,isdgmr,isym,iter,itol,itmax,iunit,
     &  jscal,nelt
      double precision bnrm,dnrm2,err,d1mach,fuzz,rat,ratmax,tem,tol
      external dscal
      EXTERNAL MSOLVE
