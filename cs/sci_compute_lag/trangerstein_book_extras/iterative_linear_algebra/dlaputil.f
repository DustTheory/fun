...
c     IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      integer i,ibgn,icol,iend,itemp,iunit,j,jobret
...
CVD$R NOCONCUR
      ...
      integer i,ij,j,kflag,k,kk,l,m,nn
      double precision r
C
...
c     IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      integer i,ibgn,iend,icol,itemp,j
      double precision temp
C
...
c     IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      ...
      integer i,icol,irow,iunit,j,jbgn,jend,nmax
C
