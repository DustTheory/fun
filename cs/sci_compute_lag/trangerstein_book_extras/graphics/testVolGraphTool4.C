...
//**********************************************************************
// "$Header: /home/faculty/johnt/cvs/deal_new/graphics/testVolGraphTool4.C,v 1.1 2009/08/20 17:31:49 johnt Exp $"
#include <limits.h>
#include <stdlib.h>
#include <unistd.h>
#include "GTKWindow.H"
...
//open graphics output window
...

  {
    ...
    Surface<SurfaceDataSet> *object=
      OPERATOR_NEW Surface<SurfaceDataSet>(&dataset, g, 1);
