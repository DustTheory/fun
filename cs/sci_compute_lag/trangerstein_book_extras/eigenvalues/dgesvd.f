...
*
     ...
     $                   IERR )
            ...
            print *, "dgebrd 1977 took ",elapsed," seconds"
            print *, "LWORK,preferred = ",LWORK-IWORK+1,3*N+(M+N)*NB
            IF( WNTUAS ) THEN
               print *, "WNTUAS 1984"
*
...
*
     ...
     $                      WORK( IWORK ), LWORK-IWORK+1, IERR )
               call dtime(tarray,reslt)
               elapsed=tarray(1)-start
               print *, "dorgbr 1997 took ",elapsed," seconds"
               print *, "LWORK,preferred = ",LWORK-IWORK+1,3*N+NCU*NB
            END IF
            IF( WNTVAS ) THEN
            print *, "WNTVAS 2005"
*
...
*
     ...
     $                      WORK( IWORK ), LWORK-IWORK+1, IERR )
               call dtime(tarray,reslt)
               elapsed=tarray(1)-start
               print *, "dorgbr 2013 took ",elapsed," seconds"
               print *, "LWORK,preferred = ",LWORK-IWORK+1,3*N+(N-1)*NB
            END IF
            IF( WNTUO ) THEN
*
...
*
     ...
     $                      LDVT, U, LDU, DUM, 1, WORK( IWORK ), INFO )
               call dtime(tarray,reslt)
               elapsed=tarray(1)-start
               print *, "dbdsqr 2058 took ",elapsed," seconds"
