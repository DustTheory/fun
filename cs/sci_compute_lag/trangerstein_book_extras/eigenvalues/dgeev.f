...
*
      IBAL = 1
      CALL DGEBAL( 'N', N, A, LDA, ILO, IHI, WORK( IBAL ), IERR ) ! JAT
      print *, "after dgebal, A = ",((A(i,j),j=1,n),i=1,n)
*
...
*
     ...
     $             LWORK-IWRK+1, IERR )
      print *, "after dgehrd, A = ",((A(i,j),j=1,n),i=1,n)
*
      IF( WANTVL ) THEN
*
...
*
     ...
     $                WORK( IWRK ), LWORK-IWRK+1, INFO )
         print *, "after dhseqr, wr = ",(wr(i),j=1,n)
         print *, "wi = ",(wi(i),j=1,n)
      END IF
*
