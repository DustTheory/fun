...
*
     ...
     $                  LDC )
         ...
         print *, "lower 351 took ",elapsed," seconds"
      END IF
*
...
*
  160 CONTINUE
      call dtime(tarray,reslt)
      elapsed=tarray(1)-start
      print *, "loop 60 of dbdsqr ",elapsed," seconds"
      DO 170 I = 1, N
         IF( D( I ).LT.ZERO ) THEN
            D( I ) = -D( I )
*
...
*
      print *, "sort singular values in dbdsqr 821"
      call dtime(tarray,reslt)
      start=tarray(1)
      DO 190 I = 1, N - 1
*
...
*
  ...
  190 CONTINUE
      call dtime(tarray,reslt)
      elapsed=tarray(1)-start
      print *, "sort singular values in dbdsqr 821 took ",
     &  elapsed," seconds"
      GO TO 220
*
